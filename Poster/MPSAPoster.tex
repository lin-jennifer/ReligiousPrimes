...
\begin{itemize} \compresslist
	...
	\item There was no interaction between the prime condition and argument condition on agreement to the subject.
\end{itemize} 
...
\begin{itemize}\compresslist
	...
	\item \tb{The Topic:} Abortion is a polarizing subject with people having preconceptions on where they stand. Future iterations of the study can analyze how people react to topics that are given less attention in the media, with religious primes added to the experiment. 
\end{itemize}
